  ...
  return doctor && (
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        <div>
          <img className='bg-primary w-full sm:max-w-72 rounded-lg' src={doctor.imageUrl} alt='' />
        </div>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          <div className='flex items-center gap-2 text-sm mt-1 text-gray-600'>
            ...
            <button className='py-0.5 px-2 border text-xs rounded-full'>{doctor.experience} Year</button>
          </div>
          ...
          <div>
            ...
            <p className='text-sm text-gray-500 max-w-[700px] mt-1'>{doctor.description}</p>
          </div>
